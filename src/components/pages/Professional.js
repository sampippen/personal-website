  ...
  return (
    <>
      <div>
        ...
        <h4>Electrical</h4>
        <h5>Built cables and circuits</h5>
        <h4>Hardware</h4>
        <h5>Assembled remote camera terminal</h5>
        <h4>3D Modeling</h4>
        <h5>Made custom cases for circuits</h5>
        <h4>Software</h4>
        <h5>Solder reflow oven</h5>

        <h2>Visa, Inc.</h2>
        <h3>Software Engineering Intern</h3>
        <h4>Frontend</h4>
        <h5>Angular.js, NgRx</h5>
        <h4>Backend</h4>
        <h5>Java Springboot, some other thing I'm probably not thinking of</h5>
        <h4>Database</h4>
        <h5>MongoDB, MySQL</h5>
        <h4>Deployment</h4>
        <h5>Tbh idk how we deployed our website</h5>
        <h4>Tools</h4>
        <h5>Studio 3T, MySQL Workbench, Bitbucket, JIRA, etc.</h5>
      </div>
    </>
  );
}
